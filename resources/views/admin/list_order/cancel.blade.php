...
<div class="card">
    <div class="card-header font-weight-bold">
        ...
        DANH SÁCH KHÁCH HÀNG ĐÃ HỦY ĐƠN HÀNG
    </div>
    <div class="card-body">
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="">
                        <span class="badge badge-dark p-1">{{ $show->status }}</span>
                    </td>
    ...
    @else
    <p class="text-danger"> HIỆN TẠI CHƯA CÓ KHÁCH HÀNG NÀO HỦY ĐƠN HÀNG !</p>
    @endif
</div>
@endsection