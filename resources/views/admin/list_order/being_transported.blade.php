...
<div class="card">
    <div class="card-header font-weight-bold">
        ...
        DANH SÁCH KHÁCH HÀNG ĐANG VẬN CHUYỂN ĐƠN HÀNG
    </div>
    <div class="card-body">
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="">
                        <span class="badge badge-info p-1">{{ $show->status }}</span>
                    </td>
    ...
    @else
    <p class="text-danger"> HIỆN TẠI CHƯA CÓ KHÁCH HÀNG NÀO ĐANG XỬ LÝ VẬN CHUYỂN ĐƠN HÀNG !</p>
    @endif
</div>
@endsection