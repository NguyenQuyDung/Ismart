...
<div id="main-content-wp" class="clearfix category-product-page">
        ...
        <div class="secion" id="breadcrumb-wp">
            <div class="secion-detail">
                <ul class="list-item clearfix">
                    ...
                    <li>
                        <a href="" title="">Sắp xếp sản phẩm</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    line-height:normal;">Kết quả sắp xếp</h3>
                    <div class="filter-wp fl-right" style="position: absolute;right: 170px;top: 165px;">
                        <p class="desc">Hiển thị <b style="color:black; font-weight:bold;">{{($count_product)}}</b> trên <b style="color:black; font-weight:bold;">{{($count_total_list_product)}}</b> sản phẩm</p>
