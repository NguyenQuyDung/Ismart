...
(function(e, t) {
    ...
    function en(e, t, n, r) {
        ...
        for (; i < 4; i += 2)
            ...
            (n === "content" &&
                ...
                n !== "margin" &&
                (s -=
                    parseFloat(Dt(e, "border" + $t[i] + "Width")) ||
                    0)) :
            ((s += parseFloat(Dt(e, "padding" + $t[i])) || 0),
                n !== "padding" &&
                (s +=
    ...
    function Gn(e, t, n) {
        ...
        n.queue ||
            ...
            ((n.overflow = [p.overflow, p.overflowX, p.overflowY]),
                ...
                v.css(e, "float") === "none" &&
                (!v.support.inlineBlockNeedsLayout ||
                    nn(e.nodeName) === "inline" ?
                ...
                if (s && (s[1] || !n)) {
                    if (s[1])
                        return (
                            ...
                            (a =
                                n && n.nodeType ? n.ownerDocument || n : i),
            ...
            parseHTML: function(e, t, n) {
                ...
                return !e || typeof e != "string" ?
                    ...
                    (typeof t == "boolean" && ((n = t), (t = 0)),
                        (t = t || i),
                        (r = E.exec(e)) ? [t.createElement(r[1])] :
                        ((r = v.buildFragment([e], t, n ? null : [])),
                            v.merge(
                                [],
                                (r.cacheable ? v.clone(r.fragment) : r.fragment)
                                .childNodes
                            )));
            },
                    ...
                    ((r = e.split(".", 2)),
                        ...
                        v.access(
                            ...
                            function(n) {
                                if (n === t)
                                    return (
                                        (l = this.triggerHandler("getData" + i, [
                                            r[0],
                                        ])),
                                        l === t &&
                                        a &&
                ...
                if (!arguments.length) {
                    if (s)
                        return (
                            (n =
                                v.valHooks[s.type] ||
                                v.valHooks[s.nodeName.toLowerCase()]),
    ...
    (v.event = {
        ...
        trigger: function(n, r, s, o) {
            if (!s || (s.nodeType !== 3 && s.nodeType !== 8)) {
                ...
                return (
                    ...
                    (!p._default ||
                        p._default.apply(s.ownerDocument, r) === !1) &&
        ...
        dispatch: function(n) {
            ...
            for (r = 0; r < w.length && !n.isPropagationStopped(); r++) {
                ...
                for (
                    i = 0; i < a.matches.length && !n.isImmediatePropagationStopped(); i++
                ) {
                    c = a.matches[i];
                    if (
                        y ||
                        ...
                        (n.handleObj = c),
                        (o = (
                            (v.event.special[c.origType] || {}).handle ||
                            c.handler
                        ).apply(a.elem, g)),
                        o !== t &&
                        ((n.result = o),
    ...
    v.each({ mouseenter: "mouseover", mouseleave: "mouseout" },
        ...
        (v.event.special.change = {
            ...
            teardown: function() {
                return (
                    v.event.remove(this, "._change"), !$.test(this.nodeName)
                );
            },
        }),
        ...
        (function(e, t) {
                        ...
                        if ((f = i[1])) {
                            ...
                            if (i[2])
                                return (
                                    S.apply(
                                        n,
                                        x.call(t.getElementsByTagName(e), 0)
                                    ),
                                    n
                                );
                            if ((f = i[3]) && Z && t.getElementsByClassName)
                                return (
                                    S.apply(
                                        n,
                                        x.call(t.getElementsByClassName(f), 0)
                                    ),
                                    n
                                );
                        }
            ...
            var n,
                ...
                Q = K(function(e) {
                    return (
                        e.appendChild(g.createComment("")), !e.getElementsByTagName("*").length
                    );
                }),
                G = K(function(e) {
                    return (
            ...
            (i = nt.selectors = {
                ...
                find: {
                    ...
                    CLASS: Z &&
                        function(e, t, n) {
                            if (
                                typeof t.getElementsByClassName !== p &&
                                !n
                            )
                        ...
                        return e === "nth" ?
                            ...
                            function(e) {
                                ...
                                if (s) {
                                    i = 0;
                                    for (
                                        t = s.firstChild; t; t = t.nextSibling
                                    )
                                        if (t.nodeType === 1) {
                                            i++;
                                            if (e === t) break;
        ...
        v.extend({
            filter: function(e, t, n) {
                return (
                    n && (e = ":not(" + e + ")"),
                    t.length === 1 ?
                    v.find.matchesSelector(t[0], e) ? [t[0]] : [] :
                    v.find.matches(e, t)
                );
            },
            dir: function(e, n, r) {
        ...
        (v.buildFragment = function(e, n, r) {
            ...
            return (
                ...
                ((s = n.createDocumentFragment()),
                    v.clean(e, n, s, r),
                    o && (v.fragments[a] = u && s)), { fragment: s, cacheable: o }
            );
        }),
        (v.fragments = {}),
        v.each({
    ...
    v.fn.extend({
        ...
        v.extend({
            ...
            style: function(e, n, r, i) {
                ...
                if (r === t)
                    return u && "get" in u && (s = u.get(e, !1, i)) !== t ?
                        s :
                        f[n];
                (o = typeof r),
                o === "string" &&
        ...
        ((v.expr.filters.hidden = function(e) {
                return (
                    ...
                    (!v.support.reliableHiddenOffsets &&
                        ((e.style && e.style.display) || Dt(e, "display")) ===
                        "none")
                );
            }),
            ...
            if (!n.crossDomain || v.support.cors) {
                ...
                return {
                    send: function(i, s) {
                        ...
                        n.mimeType &&
                            a.overrideMimeType &&
                            a.overrideMimeType(n.mimeType), !n.crossDomain &&
                            !i["X-Requested-With"] &&
    ...
    (Yn.prototype = {
        ...
        cur: function() {
            ...
            return e && e.get ?
                e.get(this) :
                Yn.propHooks._default.get(this);
        },
        run: function(e) {
            var t,
        ...
        _default: {
            ...
            set: function(e) {
                v.fx.step[e.prop] ?
                    v.fx.step[e.prop](e) :
                    e.elem.style &&
                    (e.elem.style[v.cssProps[e.prop]] != null ||
                        v.cssHooks[e.prop]) ?
        ...
        return (r = c.body) === l ?
            ...
            ((n = c.documentElement),
                ...
                (typeof l.getBoundingClientRect != "undefined" &&
                    ...
                    (a = i.pageXOffset || n.scrollLeft), { top: f.top + u - s, left: f.left + a - o }) :
                f);
    }),
    (v.offset = {
        bodyOffset: function(e) {
            ...
            return (
                ...
                ((t += parseFloat(v.css(e, "marginTop")) || 0),
                    (n += parseFloat(v.css(e, "marginLeft")) || 0)), { top: t, left: n }
            );
        },
    ...
    v.fn.extend({
            position: function() {
                ...
                var e = this[0],
                    t = this.offsetParent(),
                    n = this.offset(),
                    r = er.test(t[0].nodeName) ? { top: 0, left: 0 } :
                    t.offset();
                return (
